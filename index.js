...
var SVGStore = require('broccoli-misvg');
...
module.exports = {
  ...
  options: function() {
    return this._options = this._options || merge(true, {}, {
        files: []
      }, this.app.options.misvg || {});
  },

  treeForPublic: function() {
    var options = this.options();
    var trees = this._makeSvgTrees(options.files, options.misvgOptions);
  ...
  _makeSvgTrees: function(files, misvgOptions) {
